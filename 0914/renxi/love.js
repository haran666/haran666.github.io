(function(window){
    ...
    Seed.prototype = {
        ...
        drawHeart: function() {
            ...
            ctx.save();
            ctx.fillStyle = color;
            ctx.shadowColor = 'rgba(255, 110, 150, 0.8)';
            ctx.shadowBlur = 16;
    ...
    Branch.prototype = {
        ...
        draw: function(p) {
            ...
            ctx.save();
        	ctx.beginPath();
        	ctx.fillStyle = 'rgba(96, 42, 60, 0.92)';
            ctx.shadowColor = 'rgba(255, 130, 165, 0.35)';
            ctx.shadowBlur = 4;
        	ctx.moveTo(p.x, p.y);
    ...
    Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        this.tree = tree;
        this.point = point;
        this.color = color || 'rgb(255,' + random(128, 196) + ',' + random(170, 215) + ')';
        this.alpha = alpha || 0.35 + Math.random() * 0.6;
    ...
    Bloom.prototype = {
        ...
        draw: function() {
            ...
            ctx.shadowColor = 'rgba(255, 130, 165, 0.55)';
            ctx.shadowBlur = 6;
